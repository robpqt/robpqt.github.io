...
def filter(link):
	...
	print("Comptage de mot a marché !")

	return results

def test():
	foutWordsCount = open("/Users/robpqt/Documents/leDevoir/data/wordsCount3.csv","w")
	c = csv.writer(foutWordsCount)

	wordsTable = filter("/Users/robpqt/Documents/leDevoir/data/textToAnalyze3.txt")
	wordsCount = []
