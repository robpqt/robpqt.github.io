...
def filter(link):
	...
	print("Le comptage de mot du débat 1 a marché!")

	return results

def test():
	foutWordsCount = open("data/WordsCount.csv","w")
	c = csv.writer(foutWordsCount)

	wordsTable = filter("data/textToAnalyze.txt")
	wordsCount = []
	...
	print("L'écriture du CSV du débat 1 a marché!")
