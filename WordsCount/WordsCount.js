function comptage(link) {
	...
	// ON COMMENCE A TOUT CONSTRUIRE
		...
		g.append("text")
			...
			.text(function() {
				if(link=="data/wordsCount.csv") {
					return "DEBAT 1"
				}
				else if(link=="data/wordsCount2.csv") {
					return "DEBAT 2"
				}
				else {
					return "DEBAT 3"
...
comptage("data/wordsCount.csv");
comptage("data/wordsCount2.csv");
comptage("data/wordsCount3.csv");
